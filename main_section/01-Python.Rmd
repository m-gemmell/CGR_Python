...
author: Matthew R. Gemmell & Graeme Fox
date: "`r format(Sys.time(), '%B, %Y')`"
favicon: figures/CGR_favicon.png
description: CGR book for the Python for Bioinformatics workshop
...
<center>
![](figures/python.png){style="width:300px; border-radius:5px; background:white"}
</center>
